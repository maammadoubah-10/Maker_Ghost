...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('products.showAll') }}"><i class="fas fa-box"></i> Produits</a>
                </li>
                <li class="nav-item">
    ...
    <main role="main" class="container dashboard">
        <h2>Bienvenue sur votre tableau de bord client</h2>
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary btn-shadow">Voir les produits</a>
                    </div>
                </div>
            </div>
